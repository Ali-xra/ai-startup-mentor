...
export const newPhaseTranslations: Record<Locale, Record<string, string>> = {
    ...
    en: {
        ...
        'stage_2_1_1_description': 'Political, Economic, Social, Technological, Environmental, Legal analysis',
        ...
        'stage_2_3_2_description': 'Comprehensive analysis of product, pricing, marketing, and market share',
