        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center p-4">
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
                ...
                <div className="p-6 overflow-y-auto max-h-[60vh]">
                    ...
                    {isOwner && (
                        <form onSubmit={handleAddMember} className="mb-6 p-4 bg-slate-50 dark:bg-slate-700/50 rounded-lg">
                    ...
                    <div className="space-y-3">
                        ...
                        {isLoading ? (
                            ...
                            members.map((member) => (
                                <div key={member.id} className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-700/50 rounded-lg">
