...
export const StageIndicator: React.FC<StageIndicatorProps> = ({ stages, currentStage, selectedStageForPreview, onStageSelect, locale }) => {
        ...
        <div className="p-3 bg-slate-100 dark:bg-slate-800/50 rounded-2xl border border-slate-200 dark:border-slate-700 h-full overflow-y-auto w-full">
            ...
            <div className="space-y-2">
                ...
                {ALL_PHASES.phases.map((phase) => {
                    const phaseStages = phase.subsections.flatMap(sub => sub.stages.map(s => s.id as Stage));
