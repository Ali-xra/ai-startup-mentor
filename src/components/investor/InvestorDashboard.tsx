      ...
      <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            {/* Tier Badge */}
            <div className={`px-4 py-2 rounded-full text-sm font-medium ${tierBadgeColors[investorProfile.tier]}`}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 dark:text-white mt-2">
                  {stats?.monthly_views_remaining === -1 ? '∞' : stats?.monthly_views_remaining || 0}
                </p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              <svg className="w-8 h-8 text-blue-600 dark:text-blue-400 ml-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              <svg className="w-8 h-8 text-green-600 dark:text-green-400 ml-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" />
              </svg>
              <div className="text-right">
                <p className="font-medium text-gray-900 dark:text-white">پروژه‌های ذخیره شده</p>
                <p className="text-sm text-gray-600 dark:text-gray-400">{stats?.saved_projects_count || 0} پروژه</p>
              </div>
            </button>
            ...
            >
              <svg className="w-8 h-8 text-purple-600 dark:text-purple-400 ml-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-right">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">{stats?.accepted_connections || 0} فعال</p>
              </div>
            </button>
          </div>
        </div>
        ...
        {investorProfile.tier === 'free' && (
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg shadow p-6 border border-blue-200 dark:border-blue-800">
            <div className="flex items-start justify-between">
              ...
              <svg className="w-16 h-16 text-blue-400 dark:text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
