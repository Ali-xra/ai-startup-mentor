            ...
            <div className="flex items-center">
              <Link to="/investor" className="flex items-center space-x-3 space-x-reverse">
                ...
                <div className="hidden md:block">
                  <h1 className="text-lg font-bold text-slate-900 dark:text-slate-100">پورتال سرمایه‌گذار</h1>
                </div>
              </Link>
            </div>
            ...
            <div className="relative">
              ...
              >
                <div className="hidden md:block text-right">
                  ...
                  {investorProfile && (
                    <p className={`text-xs px-2 py-0.5 rounded-full inline-block ${tierBadgeColors[investorProfile.tier]}`}>
