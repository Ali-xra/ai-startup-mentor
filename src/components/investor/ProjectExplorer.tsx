...
export const ProjectExplorer: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      {/* هدر */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">کشف پروژه‌ها</h1>
      ...
      {viewLimitReached && (
        <div className="mb-6 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
          <div className="flex items-start">
            <svg
              className="w-6 h-6 text-yellow-600 dark:text-yellow-500 ml-3 flex-shrink-0"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <div>
              ...
              <p className="text-sm text-yellow-800 dark:text-yellow-300 mb-3">
                شما در این ماه به حد مجاز 10 بازدید رسیده‌اید. برای دسترسی نامحدود، حساب خود را
                ارتقا دهید.
              </p>
      ...
      {/* فیلترها */}
      <ProjectFilters onFiltersChange={handleFiltersChange} initialFilters={filters} />
