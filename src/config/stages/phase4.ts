...
export const PHASE_4: PhaseConfig = {
  ...
  description_en: 'Your brand is more than just a logo or a name; it\'s the feeling and perception people have about your company. In this phase, we will define the personality and identity of your business. A strong brand helps you remain memorable in the minds of customers, build trust, and differentiate yourself from the competition.',
  description_fa: 'برند شما چیزی فراتر از یک لوگو یا نام است؛ برند، احساس و برداشتی است که مردم در مورد شرکت شما دارند. در این فاز، ما شخصیت و هویت کسب‌وکار شما را تعریف می‌کنیم. یک برند قوی به شما کمک می‌کند تا در ذهن مشتریان ماندگار شوید، اعتماد ایجاد کنید و خود را از رقبا متمایز سازید.',
      ...
      stages: [
        {
          ...
          guidance_en: 'The vision is the future you want to create with your business. It\'s a big, inspiring, long-term goal that shows what you ultimately want to achieve and what impact you want to have on the world.',
          guidance_fa: 'چشم‌انداز، تصویر آینده‌ای است که می‌خواهید با کسب‌وکارتان بسازید. این یک هدف بزرگ، الهام‌بخش و بلندمدت است که نشان می‌دهد در نهایت می‌خواهید به چه چیزی برسید و چه تاثیری در دنیا داشته باشید.',
          question_en: 'What does a world where your startup has succeeded look like? What is your ultimate, aspirational vision?',
          question_fa: 'دنیایی که استارت‌آپ شما در آن موفق شده است، چه شکلی خواهد بود؟ چشم‌انداز نهایی و آرمانی شما چیست؟',
          ...
          promptConfig: {
            ...
            outputFormat: 'A short, inspiring statement (1-2 sentences) describing the long-term impact.',
        ...
        },
        {
          ...
          guidance_en: 'The mission is a practical, present-day statement that defines your company\'s core purpose. It answers the questions: "What do we do? Who do we do it for? And how do we do it?"',
          guidance_fa: 'ماموریت، بیانیه‌ای عملی و امروزی است که هدف اصلی شرکت شما را تعریف می‌کند. ماموریت به این سوال پاسخ می‌دهد: "ما چه کار می‌کنیم؟ برای چه کسی این کار را انجام می‌دهیم؟ و چگونه آن را انجام می‌دهیم؟"',
          question_en: 'What is the core, day-to-day purpose of your business? Write your mission statement in one clear sentence.',
          question_fa: 'هدف اصلی و روزمره کسب‌وکار شما چیست؟ بیانیه ماموریت خود را در یک جمله واضح بنویسید.',
          userInputRequired: false,
          outputType: 'text',
          ...
          promptConfig: {
            ...
            outputFormat: 'A single, clear sentence defining what the company does, for whom, and how, in an actionable way.',
        ...
        },
        {
          ...
          guidance_en: 'Values are the guiding principles and beliefs of your company that govern all your decisions and behavior. These values shape your brand\'s character and define what you stand for.',
          guidance_fa: 'ارزش‌ها، اصول و باورهای راهنمای شرکت شما هستند که بر تمام تصمیمات و رفتار شما حاکم‌اند. این ارزش‌ها شخصیت برند شما را شکل می‌ده دهند و مشخص می‌کنند که شما پایبند به چه چیزهایی هستید.',
          question_en: 'What are the 3 to 5 key principles that guide your company\'s culture and decisions? (e.g., Innovation, Customer-Centricity, Simplicity, Transparency).',
          question_fa: '۳ تا ۵ اصل کلیدی که فرهنگ و تصمیمات شرکت شما را هدایت می‌کنند کدامند؟ (مثلاً: نوآوری، مشتری‌مداری، سادگی، شفافیت).',
          userInputRequired: false,
          outputType: 'list',
          ...
          promptConfig: {
            ...
            outputFormat: 'A bulleted list of 3-5 core values, each with a one-sentence explanation of its practical meaning.',
        ...
        },
        {
          ...
          title_fa: 'شخصیت برند',
          guidance_en: 'If your brand were a person, what personality traits would it have? Would it be serious and expert-like, or witty and friendly? Defining a brand personality helps you maintain a consistent tone.',
          guidance_fa: 'اگر برند شما یک انسان بود، چه ویژگی‌های شخصیتی داشت؟ آیا جدی و متخصص بود یا شوخ‌طبع و دوستانه؟ تعریف شخصیت برند به شما کمک می‌کند تا در تمام ارتباطات خود لحنی یکپارچه داشته باشید.',
          question_en: 'If your brand were a person, describe it with 3 to 5 adjectives. (e.g., Innovative, Trustworthy, Energetic).',
          question_fa: 'اگر برند شما یک شخص بود، آن را با ۳ تا ۵ صفت توصیف کنید. (مثلاً: نوآور، قابل اعتماد، پرانرژی).',
          userInputRequired: false,
          outputType: 'list',
          ...
          promptConfig: {
            ...
            outputFormat: 'A list of 3-5 key personality traits (adjectives), with a brief justification for why each is appropriate.',
      ...
      stages: [
        {
          ...
          title_en: 'Brand Name',
          title_fa: 'نام برند',
          guidance_en: 'A good name should be memorable, easy to pronounce, unique, and relevant. You should also ensure its website domain and social media handles are available.',
          guidance_fa: 'یک نام خوب باید به یاد ماندنی، قابل تلفظ، منحصر به فرد و مرتبط با کسب‌وکار شما باشد. همچنین باید مطمئن شوید که دامنه وب‌سایت و شناسه‌های شبکه‌های اجتماعی آن در دسترس است.',
          question_en: 'Brainstorm several options for your brand name. Which one best meets the criteria for a good name?',
          question_fa: 'چندین گزینه برای نام برند خود پیشنهاد دهید. کدام یک از آن‌ها معیارهای یک نام خوب را بهتر برآورده می‌کند؟',
          ...
          promptConfig: {
            ...
            outputFormat: 'A list of 5-10 brand name suggestions, categorized by naming strategy (e.g., Descriptive, Evocative, Invented).',
        ...
        },
        {
          ...
          guidance_en: 'A tagline is a short, memorable phrase that summarizes your brand\'s core value or mission. It often appears alongside your logo and helps customers quickly understand what you do.',
          guidance_fa: 'شعار، یک عبارت کوتاه و به یاد ماندنی است که ارزش اصلی یا ماموریت برند شما را خلاصه می‌کند. این شعار معمولاً در کنار لوگوی شما قرار می‌گیرد و به مشتریان کمک می‌کند تا به سرعت بفهمند شما چه کار می‌کنید.',
          question_en: 'Write a short, catchy tagline that communicates your brand\'s core promise to the customer.',
        ...
        },
        {
          ...
          title_fa: 'لحن صدا',
          guidance_en: 'Tone of voice is the implementation of your brand\'s personality in words. It defines how you speak to your audience: formal or informal, technical or simple, serious or humorous.',
          guidance_fa: 'لحن صدا، نحوه پیاده‌سازی شخصیت برند شما در کلمات است. این لحن مشخص می‌کند که شما چگونه با مخاطبان خود صحبت می‌کنید؛ رسمی یا غیررسمی، فنی یا ساده، جدی یا طنزآمیز.',
          question_en: 'Based on the brand personality you\'ve defined, what should be the tone of your communication with customers? (e.g., Friendly and Supportive, Professional and Inspiring).',
          question_fa: 'بر اساس شخصیت برندی که تعریف کردید، لحن ارتباط شما با مشتریان چگونه باید باشد؟ (مثلاً: دوستانه و حمایتگر، حرفه‌ای و الهام‌بخش).',
          userInputRequired: false,
          outputType: 'text',
          ...
          promptConfig: {
            ...
            outputFormat: 'A description of the tone of voice, structured with a general description, a "We are... / We are not..." format, and examples.',
      ...
      stages: [
        {
          ...
          guidance_en: 'The logo is the visual symbol of your brand. A good logo is simple, memorable, and appropriate. At this stage, just think about the core ideas and concepts.',
          guidance_fa: 'لوگو نماد بصری برند شماست. یک لوگوی خوب، ساده، به یاد ماندنی و متناسب با شخصیت برند شماست. در این مرحله، فقط به ایده‌ها و مفاهیم اصلی فکر کنید.',
          question_en: 'What symbols, concepts, or visual styles could represent your brand well? Describe your initial ideas for the logo.',
          question_fa: 'چه نمادها، مفاهیم یا سبک‌های بصری می‌توانند به خوبی معرف برند شما باشند؟ ایده‌های اولیه خود برای لوگو را توصیف کنید.',
          userInputRequired: false,
          outputType: 'analysis',
          ...
          promptConfig: {
            ...
            outputFormat: 'A description of 3 different logo concepts, explaining the symbolism, style, and mood for each.',
            constraints: { tone: 'creative', complexity: 'moderate' },
        ...
        },
        {
          ...
          title_fa: 'پالت رنگی',
          guidance_en: 'Colors evoke strong emotions and play a crucial role in brand recognition. A defined color palette helps create a consistent visual identity.',
          guidance_fa: 'رنگ‌ها احساسات قوی را برمی‌انگیزند و نقش مهمی در شناخت برند دارند. یک پالت رنگی مشخص به ایجاد یک هویت بصری یکپارچه کمک می‌کند.',
          question_en: 'What colors best convey your brand\'s personality and values? (e.g., blue for trust, green for growth, red for energy).',
          question_fa: 'چه رنگ‌هایی به بهترین شکل شخصیت و ارزش‌های برند شما را منتقل می‌کنند؟ (مثلاً آبی برای اعتماد، سبز برای رشد، قرمز برای انرژی).',
          userInputRequired: false,
          outputType: 'analysis',
          ...
          promptConfig: {
            ...
            outputFormat: 'A proposed color palette with HEX codes for primary, secondary, and accent colors, including a brief explanation for each color choice.',
        ...
        },
        {
          ...
          title_en: 'Typography',
          title_fa: 'تایپوگرافی',
          guidance_en: 'The fonts you use also influence your brand\'s personality. Typography should be legible, consistent with the brand\'s tone, and unified.',
          guidance_fa: 'فونت‌هایی که استفاده می‌کنید نیز بر شخصیت برند شما تأثیر می‌گذارند. تایپوگرافی باید خوانا، متناسب با لحن برند و یکپارچه باشد.',
          question_en: 'What type of fonts (e.g., modern, classic, friendly) align with your brand\'s personality?',
          question_fa: 'چه نوع فونت‌هایی (مثلاً مدرن، کلاسیک، دوستانه) با شخصیت برند شما هماهنگ هستند؟',
          userInputRequired: false,
          outputType: 'analysis',
          ...
          promptConfig: {
            ...
            outputFormat: 'A recommendation for a headline font and a body font (preferably from Google Fonts), with a justification and links to the fonts.',
            constraints: { tone: 'design-oriented', complexity: 'moderate' },
