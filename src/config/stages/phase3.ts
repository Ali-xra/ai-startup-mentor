      ...
      stages: [
        {
          ...
          guidance_en: 'This block answers the question: "Who are we creating value for?" You need to identify the different groups of people or organizations you aim to serve. This is a summarized version of your target audience analysis.',
          guidance_fa: 'این بخش به این سوال پاسخ می‌دهد: "ما برای چه کسانی ارزش خلق می‌کنیم؟" شما باید گروه‌های مختلفی از افراد یا سازمان‌ها را که هدف قرار داده‌اید، مشخص کنید. این بخش، نسخه خلاصه‌شده تحلیل مخاطب هدف شما از فازهای قبل است.',
          question_en: 'Who are the most important customer groups you are targeting? List them separately.',
          question_fa: 'مهم‌ترین گروه‌های مشتریانی که هدف قرار می‌دهید چه کسانی هستند؟ آن‌ها را به تفکیک لیست کنید.',
          ...
          promptConfig: {
            ...
            outputFormat: 'A bulleted list of the 2-3 most important customer segments, highlighting the primary "beachhead" segment.',
        ...
        },
        {
          ...
          guidance_en: 'This is the core of your business, answering: "What problems are we solving for customers, and what value are we delivering?" Each value proposition should be linked to a specific customer segment.',
          guidance_fa: 'این بخش هسته اصلی کسب‌وکار شماست و به سوال "ما چه مشکلاتی از مشتریان را حل می‌کنیم و چه ارزشی به آن‌ها ارائه می‌دهیم؟" پاسخ می‌دهد. هر ارزش پیشنهادی باید به یک بخش خاص از مشتریان شما مرتبط باشد.',
          question_en: 'What promise or value do you deliver to each of your customer segments? Why should they choose you?',
          question_fa: 'به هر بخش از مشتریان خود چه قول یا ارزشی می‌دهید؟ چرا آن‌ها باید شما را انتخاب کنند؟',
          userInputRequired: false,
          outputType: 'list',
          ...
          promptConfig: {
            ...
            outputFormat: 'A bulleted list, where each item explicitly links a value proposition to a specific customer segment.',
        ...
        },
        {
          ...
          title_en: 'Channels',
          title_fa: 'کانال‌ها',
          guidance_en: 'Channels are the pathways through which you reach your customers and deliver your value proposition. These include channels for awareness, sales, and post-purchase support.',
          guidance_fa: 'کانال‌ها مسیرهایی هستند که از طریق آن‌ها به مشتریان خود دسترسی پیدا کرده و ارزش پیشنهادی‌تان را به آن‌ها ارائه می‌دهید. این کانال‌ها شامل اطلاع‌رسانی, فروش و پشتیبانی پس از فروش می‌شوند.',
          question_en: 'Through which channels (e.g., website, app, direct sales, partners) will you reach your customers and deliver your product?',
          question_fa: 'از چه راهی (وب‌سایت، اپلیکیشن، فروش مستقیم، شرکا و...) می‌خواهید به مشتریان خود دسترسی پیدا کنید و محصولتان را به دستشان برسانید؟',
          userInputRequired: false,
          outputType: 'list',
          ...
          promptConfig: {
            ...
            outputFormat: 'A bulleted list categorizing key channels by their function (e.g., Awareness, Sales, Support).',
        ...
        },
        {
          ...
          guidance_en: 'This block defines the type of relationship you establish with each customer segment. The relationship can range from fully automated to highly personal.',
          guidance_fa: 'این بخش نوع رابطه‌ای را که با هر بخش از مشتریان خود برقرار می‌کنید، مشخص می‌کند. این رابطه می‌تواند کاملاً خودکار (مانند یک سرویس آنلاین) یا بسیار شخصی (مانند یک مشاور اختصاصی) باشد.',
          question_en: 'What kind of relationship will you have with your customers? (e.g., online support, personal account management, user communities).',
          question_fa: 'چه نوع رابطه‌ای با مشتریان خود خواهید داشت? (مثلاً پشتیبانی آنلاین، مدیریت حساب شخصی، انجمن‌های کاربری و...).',
          userInputRequired: false,
          outputType: 'list',
          ...
          promptConfig: {
            ...
            outputFormat: 'A bulleted list describing the key types of customer relationships (e.g., Self-Service, Community Support), with a brief justification.',
        ...
        },
        {
          ...
          guidance_en: 'This block shows how your business earns money from each customer segment. There are various revenue models, such as direct sales, subscriptions, commissions, etc.',
          guidance_fa: 'این بخش نشان می‌دهد که کسب‌وکار شما چگونه از هر بخش از مشتریان خود کسب درآمد می‌کند. مدل‌های درآمدی مختلفی مانند فروش مستقیم، حق اشتراک، کارمزد، تبلیغات و... وجود دارد.',
          question_en: 'How and how much will customers pay for your value proposition? What is your primary revenue model?',
          question_fa: 'مشتریان برای ارزش پیشنهادی شما چگونه و چقدر پول پرداخت خواهند کرد؟ مدل اصلی درآمدزایی شما چیست؟',
          userInputRequired: false,
          outputType: 'list',
          dataKey: 'bmc_revenue_streams', // ✅ Correct
          promptConfig: {
            role: 'You are a startup mentor helping to identify viable revenue streams for the BMC.',
            contextKeys: ['bmc_value_propositions', 'bmc_customer_segments', 'competitor_analysis', 'userInput'],
            goal: 'Identify the primary revenue stream and potential secondary streams, with justification.',
            outputFormat: 'A bulleted list detailing the recommended primary revenue model (e.g., Subscription - SaaS) and any potential secondary streams.',
        ...
        },
        {
          ...
          guidance_en: 'Key resources are the most important assets required to make your business model work. These can be physical, financial, intellectual, or human.',
          guidance_fa: 'منابع کلیدی، مهم‌ترین دارایی‌های مورد نیاز برای به کار انداختن مدل کسب‌وکار شما هستند. این منابع می‌توانند فیزیکی (تجهیزات)، مالی (سرمایه)، معنوی (دانش فنی، برند) یا انسانی (تیم متخصص) باشند.',
          question_en: 'What are the most critical resources you need to deliver your value proposition and operate your business? (e.g., software platform, development team, initial capital).',
          question_fa: 'مهم‌ترین منابعی که برای ارائه ارزش پیشنهادی و کارکرد کسب‌وکارتان نیاز دارید چیست؟ (مثلاً پلتفرم نرم‌افزاری، تیم توسعه‌دهنده، سرمایه اولیه).',
          userInputRequired: false,
          outputType: 'list',
          dataKey: 'bmc_key_resources', // ✅ Correct
          promptConfig: {
            role: 'You are a startup mentor helping identify key resources for the BMC.',
            contextKeys: ['bmc_value_propositions', 'bmc_channels', 'unfair_advantage', 'userInput'],
            goal: 'Identify the most critical assets needed for the business to succeed.',
            outputFormat: 'A bulleted list categorized by resource type (Intellectual, Human, Financial, Physical).',
            constraints: { tone: 'practical', complexity: 'simple' },
        ...
        },
        {
          ...
          guidance_en: 'This block includes the most important things your company must continuously do for its business model to succeed, like software development, marketing, or customer support.',
          guidance_fa: 'این بخش شامل مهم‌ترین کارهایی است که شرکت شما باید به طور مداوم انجام دهد تا مدل کسب‌وکارش موفق شود. این فعالیت‌ها می‌توانند شامل توسعه نرم‌افزار، بازاریابی، یا حل مشکلات مشتریان باشند.',
          question_en: 'What are the most essential activities you must perform daily for your business to succeed? (e.g., product development, customer acquisition, technical support).',
          question_fa: 'ضروری‌ترین فعالیت‌هایی که باید هر روز انجام دهید تا کسب‌وکارتان موفق شود کدامند؟ (مثلاً توسعه محصول، جذب مشتری، پشتیبانی فنی).',
          userInputRequired: false,
          outputType: 'list',
          ...
          promptConfig: {
            ...
            outputFormat: 'A bulleted list of the 3-5 most important activities, prioritized by importance.',
        ...
        },
        {
          ...
          guidance_en: 'No business succeeds alone. This block includes the network of suppliers and partners that help your business model succeed. These partnerships can reduce risks and improve your access to resources.',
          guidance_fa: 'هیچ کسب‌وکاری به تنهایی موفق نمی‌شود. این بخش شامل شبکه تامین‌کنندگان و شرکایی است که به موفقیت مدل کسب‌وکار شما کمک می‌کنند. این مشارکت‌ها می‌توانند ریسک‌ها را کاهش داده و دسترسی شما به منابع را بهبود بخشند.',
          question_en: 'Which companies, suppliers, or partners are critical to your business\'s success?',
          ...
          promptConfig: {
            ...
            outputFormat: 'A bulleted list of potential partner types with a brief rationale for why each partnership is valuable.',
            constraints: { tone: 'strategic', complexity: 'simple' },
        ...
        },
        {
          ...
          guidance_en: 'This block describes all the costs you will incur to operate your business model. Identifying the most significant and largest costs will help you with financial management.',
          guidance_fa: 'این بخش تمام هزینه‌هایی را که برای اجرای مدل کسب‌وکار خود متحمل می‌شوید، توصیف می‌کند. شناسایی مهم‌ترین و بزرگ‌ترین هزینه‌ها به شما در مدیریت مالی کمک می‌کند.',
          question_en: 'What will be the largest and most important costs in your business? (e.g., team salaries, server costs, marketing budget).',
          question_fa: 'بزرگ‌ترین و مهم‌ترین هزینه‌های کسب‌وکار شما چه خواهد بود؟ (مثلاً حقوق تیم، هزینه سرورها، بودجه بازاریابی).',
          userInputRequired: false,
          outputType: 'list',
          ...
          promptConfig: {
            ...
            outputFormat: 'A bulleted list of the main cost drivers, categorized under "Fixed Costs" and "Variable Costs."',
