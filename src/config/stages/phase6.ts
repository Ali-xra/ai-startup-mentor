...
export const PHASE_6: PhaseConfig = {
  ...
  description_en:
    "Having a great product isn't enough; you need to get it into the hands of the right customers. In this phase, we'll design a roadmap to attract, engage, and convert your target audience into loyal customers. A solid marketing and sales strategy will be the growth engine for your startup.",
  description_fa:
    'داشتن یک محصول عالی نیست؛ شما باید بتوانید آن را به دست مشتریان مناسب برسانید. در این فاز، ما یک نقشه راه برای جذب، درگیر کردن و تبدیل مخاطبان به مشتریان وفادار طراحی می‌کنیم. یک استراتژی بازاریابی و فروش خوب، موتور رشد استارت‌آپ شما خواهد بود.',
      ...
      stages: [
        {
          ...
          guidance_en:
            'Your marketing objectives should be specific, measurable, and aligned with your overall business goals. These could include increasing brand awareness, acquiring users for the MVP, or generating sales leads.',
          guidance_fa:
            'اهداف بازاریابی شما باید مشخص، قابل اندازه‌گیری و در راستای اهداف کلی کسب‌وکارتان باشند. این اهداف می‌توانند شامل افزایش آگاهی از برند، جذب کاربر برای MVP یا تولید سرنخ‌های فروش باشند.',
          question_en:
            'What is the most important objective you want to achieve in the first 3 to 6 months after launching your product? (e.g., sign up 1,000 early users, get 20 demo requests).',
          question_fa:
            'مهم‌ترین هدفی که می‌خواهید در ۳ تا ۶ ماه اول پس از عرضه محصول به آن برسید چیست؟ (مثلاً: ثبت‌نام ۱۰۰۰ کاربر اولیه، دریافت ۲۰ درخواست دمو).',
          ...
          promptConfig: {
            ...
            outputFormat:
              'A single, clear objective statement that is specific, measurable, achievable, relevant, and time-bound (SMART).',
        ...
        },
        {
          ...
          guidance_en:
            'KPIs are specific metrics that help you measure your progress toward your objectives. For each objective, you should define one or more KPIs.',
          guidance_fa:
            'KPIها معیارهای مشخصی هستند که به شما کمک می‌کنند تا میزان پیشرفت خود در رسیدن به اهدافتان را اندازه‌گیری کنید. برای هر هدف، باید یک یا چند KPI تعریف کنید.',
          question_en:
            'What numbers and metrics will you track to measure the success of your marketing objective? (e.g., landing page conversion rate, customer acquisition cost (CAC)).',
          question_fa:
            'چه اعداد و معیارهایی را برای سنجش موفقیت هدف بازاریابی خود دنبال خواهید کرد؟ (مثلاً: نرخ تبدیل صفحه فرود، هزینه جذب هر کاربر (CAC)).',
          userInputRequired: false,
          outputType: 'list',
          ...
          promptConfig: {
            ...
            outputFormat:
              'A bulleted list of 3-5 key performance indicators with a brief explanation of what each measures.',
      ...
      stages: [
        {
          ...
          guidance_en:
            'This strategy focuses on creating and distributing valuable content (like blog posts, videos, podcasts) to attract and engage your target audience. The goal is to build trust and demonstrate your expertise.',
          guidance_fa:
            'این استراتژی بر روی تولید و توزیع محتوای ارزشمند (مانند مقالات وبلاگ، ویدیو، پادکست) برای جذب و درگیر کردن مخاطبان هدف تمرکز دارد. هدف، ایجاد اعتماد و نشان دادن تخصص شما در حوزه کاری‌تان است.',
          question_en:
            'What type of content can you create that would be useful and engaging for your target audience and help them better understand their problem?',
          question_fa:
            'چه نوع محتوایی می‌توانید تولید کنید که برای مخاطب هدف شما مفید و جذاب باشد و مشکل آن‌ها را بهتر برایشان روشن کند؟',
          userInputRequired: false,
          outputType: 'analysis',
          ...
          promptConfig: {
            ...
            outputFormat:
              'A list of 2-3 specific content ideas (e.g., "A blog post series on X," "A short video explaining Y") with a brief description of the format and the value it provides.',
        ...
        },
        {
          ...
          guidance_en:
            'Identify which social media platforms your target audience uses most actively and how you can connect with them there. Each social network has its own culture and language.',
          guidance_fa:
            'مشخص کنید که مخاطبان هدف شما در کدام شبکه‌های اجتماعی بیشترین فعالیت را دارند و چگونه می‌توانید در آن پلتفرم‌ها با آن‌ها ارتباط برقرار کنید. هر شبکه اجتماعی، فرهنگ و زبان خاص خود را دارد.',
          question_en:
            'Which one or two social media platforms will you focus on? What kind of content (e.g., educational, behind-the-scenes, customer testimonials) will you share there?',
          question_fa:
            'روی کدام یک یا دو شبکه اجتماعی تمرکز خواهید کرد؟ چه نوع محتوایی (مثلاً آموزشی، پشت صحنه، نظرات مشتریان) در آنجا به اشتراک خواهید گذاشت؟',
          userInputRequired: false,
          outputType: 'analysis',
          ...
          promptConfig: {
            ...
            outputFormat:
              'A recommendation for 1-2 primary social media platforms and a list of 3 content pillars (themes) with post examples.',
        ...
        },
        {
          ...
          guidance_en:
            "Paid advertising (like Google or Instagram ads) is a quick way to reach a broad audience. It's very useful for testing marketing messages and acquiring users quickly.",
          guidance_fa:
            'تبلیغات پولی (مانند تبلیغات گوگل یا اینستاگرام) راهی سریع برای رسیدن به مخاطبان گسترده است. این روش برای تست پیام‌های بازاریابی، افزایش ترافیک اولیه و جذب سریع کاربران بسیار مفید است.',
          question_en:
            'If you had a limited advertising budget, on which platform and with what message would you spend it to acquire your first users?',
          question_fa:
            'اگر بودجه محدودی برای تبلیغات داشتید، آن را در کدام پلتفرم و با چه پیامی خرج می‌کردید تا اولین کاربران خود را جذب کنید؟',
          userInputRequired: false,
          outputType: 'analysis',
          ...
          promptConfig: {
            ...
            outputFormat:
              'A complete ad campaign recommendation including platform, targeting, and ad copy.',
      ...
      stages: [
        {
          ...
          guidance_en:
            '(This section is more applicable to B2B businesses). A sales process is the step-by-step journey to convert a potential lead into a paying customer.',
          guidance_fa:
            '(این بخش بیشتر برای کسب‌وکارهای B2B کاربرد دارد). فرآیند فروش، مراحل گام‌به‌گامی است که شما طی می‌کنید تا یک مشتری بالقوه را به یک مشتری بالفعل تبدیل کنید.',
          question_en:
            'What are the main stages a potential customer goes through from the moment they learn about you until they purchase your product?',
          question_fa:
            'مراحل اصلی که یک مشتری بالقوه از لحظه آشنایی با شما تا خرید محصول طی می‌کند، چیست؟',
          userInputRequired: false,
          outputType: 'list',
          ...
          promptConfig: {
            ...
            outputFormat:
              'A numbered list of 3-5 key stages in the sales process or customer journey.',
        ...
        },
        {
          ...
          guidance_en:
            "Pricing is not just about setting a number; it's a reflection of your product's value, brand positioning, and business model. There are various models, such as flat-rate, tiered, or freemium.",
          guidance_fa:
            'قیمت‌گذاری فقط تعیین یک عدد نیست؛ بلکه بازتابی از ارزش محصول، جایگاه برند و مدل کسب‌وکار شماست. مدل‌های مختلفی مانند قیمت‌گذاری ثابت، پلکانی (Tiered)، بر اساس مصرف (Usage-based) یا فریمیوم (Freemium) وجود دارد.',
          question_en:
            'Which pricing model is most suitable for your product and why? On what basis will your initial price be determined (value, competitors, cost)?',
          question_fa:
            'چه مدل قیمت‌گذاری برای محصول شما مناسب‌تر است و چرا؟ قیمت اولیه شما بر چه اساسی تعیین خواهد شد (ارزش، رقبا، هزینه)؟',
          userInputRequired: false,
          outputType: 'analysis',
          ...
          promptConfig: {
            ...
            outputFormat:
              'A recommendation for a specific pricing model, a suggested price point or range, and a clear justification based on value, competition, and psychology.',
      ...
      stages: [
        {
          ...
          guidance_en:
            'Your product launch is a major event. A launch campaign involves a set of coordinated activities over a specific period to build excitement and attract initial users.',
          guidance_fa:
            'عرضه محصول شما یک رویداد مهم است و نیاز به برنامه‌ریزی دارد. این کمپین شامل مجموعه‌ای از فعالیت‌های هماهنگ در یک بازه زمانی مشخص برای ایجاد هیجان و جذب کاربران اولیه است.',
          question_en:
            'What are the top three activities you will do right before, on the day of, and immediately after your MVP launch to generate buzz?',
          question_fa:
            'سه فعالیت اصلی که درست قبل، در روز و بلافاصله بعد از عرضه MVP خود انجام خواهید داد تا توجهات را جلب کنید، چیست؟',
          userInputRequired: false,
          outputType: 'analysis',
          ...
          promptConfig: {
            ...
            outputFormat:
              'A simple timeline with 3 phases (Pre-Launch, Launch Day, Post-Launch) and 2-3 key, concrete activities listed for each phase.',
