...
export const PHASE_8: PhaseConfig = {
  ...
  description_en: 'In this phase, we consolidate all the work from the previous stages into professional and persuasive documents. The goal is to tell a compelling, data-driven story about your business to attract investors and secure the resources needed for growth. This phase is the culmination of all your planning.',
  description_fa: 'در این فاز، تمام کارهایی که در مراحل قبل انجام دادیم را در قالب اسنادی حرفه‌ای و قانع‌کننده جمع‌آوری می‌کنیم. هدف این است که داستانی جذاب و مبتنی بر داده در مورد کسب‌وکارتان تعریف کنید تا بتوانید نظر سرمایه‌گذاران را جلب کرده و منابع لازم برای رشد را تامین نمایید. این فاز، نقطه اوج تمام برنامه‌ریزی‌های شماست.',
      ...
      stages: [
        {
          ...
          guidance_en: 'This is one of the most critical questions any investor will ask. You need to be clear and specific about how much capital you need to reach your next set of milestones (typically for the next 12-18 months).',
          guidance_fa: 'شما باید به طور دقیق و شفاف مشخص کنید که برای رسیدن به نقاط عطف بعدی خود (معمولاً برای ۱۲ تا ۱۸ ماه آینده) به چه مقدار سرمایه نیاز دارید. این عدد باید بر اساس پیش‌بینی‌های مالی شما باشد.',
          question_en: 'Exactly how much capital do you need to execute your plans and achieve your goals for the next 12 to 18 months?',
          question_fa: 'برای اجرای برنامه‌های خود و رسیدن به اهداف ۱۲ تا ۱۸ ماه آینده، دقیقاً به چه مبلغی سرمایه نیاز دارید؟',
          ...
          promptConfig: {
            ...
            outputFormat: 'A specific monetary amount ($) with a clear, simple calculation showing how it was derived from the burn rate and key project costs.',
        ...
        },
        {
          ...
          guidance_en: 'Investors want to know exactly where their money will be spent. You need to provide a clear breakdown of how the capital will be allocated across key areas like product development, marketing, and hiring.',
          guidance_fa: 'سرمایه‌گذاران می‌خواهند بدانند که پولشان دقیقاً در کجا خرج خواهد شد. شما باید یک تقسیم‌بندی واضح از نحوه تخصیص سرمایه به بخش‌های کلیدی مانند توسعه محصول، بازاریابی و فروش، و استخدام تیم ارائه دهید.',
          question_en: 'How will you allocate the raised capital among the main departments (e.g., 40% for Team, 30% for Marketing, 20% for Operations)?',
          question_fa: 'سرمایه جذب شده را چگونه بین بخش‌های اصلی (مثلاً: ۴۰٪ برای تیم، ۳۰٪ برای بازاریابی، ۲۰٪ برای عملیات) تقسیم خواهید کرد؟',
          ...
          promptConfig: {
            ...
            contextKeys: ['fundraising_ask', 'hiring_plan', 'product_roadmap', 'marketing_objectives', 'userInput'],
            goal: 'Create a clear, percentage-based breakdown of how the funds will be used to achieve key goals.',
            outputFormat: 'A percentage-based breakdown (e.g., as a list) for key categories like Product/R&D, Sales & Marketing, and G&A/Hiring, linking each to a goal.',
      ...
      stages: [
        {
          ...
          guidance_en: 'A pitch deck is a brief (usually 10-15 slides) and visual presentation that summarizes the story of your business. It\'s your primary tool for introducing your startup to investors.',
          guidance_fa: 'پیچ دک یک ارائه کوتاه (معمولاً ۱۰ تا ۱۵ اسلاید) و بصری است که داستان کسب‌وکار شما را به طور خلاصه روایت می‌کند. این سند، ابزار اصلی شما برای معرفی استارت‌آپ به سرمایه‌گذاران است.',
          question_en: 'What is the single most important message you want an investor to remember after seeing your presentation? What will be the general structure of your slides?',
          question_fa: 'مهم‌ترین پیامی که می‌خواهید پس از دیدن ارائه شما در ذهن سرمایه‌گذار باقی بماند چیست؟ ساختار کلی اسلایدهای شما چگونه خواهد بود؟',
          userInputRequired: false,
          outputType: 'analysis',
          ...
          promptConfig: {
            ...
            contextKeys: [
              'idea_title', 'tagline', 'problem_description', 'product_description', 'som_analysis', 
              'bmc_revenue_streams', 'social_media_marketing', 'competitor_analysis', 'founding_team', 
              'revenue_forecast', 'fundraising_ask', 'use_of_funds', 'userInput'
            ],
            goal: 'Generate a standard 10-12 slide pitch deck outline by synthesizing all the information gathered.',
            outputFormat: 'A list of 10-12 slide titles, with 2-3 key bullet points under each, summarizing the essential content for that slide.',
        ...
        },
        {
          ...
          guidance_en: 'This document is a condensed, one-page summary of your entire business, often sent as a follow-up. It should include key information like the problem, solution, market, team, and contact details.',
          guidance_fa: 'این سند، خلاصه‌ای فشرده از کل کسب‌وکار شما در یک صفحه است که معمولاً پس از جلسه اول برای سرمایه‌گذار ارسال می‌شود. این خلاصه باید شامل اطلاعات کلیدی مانند مشکل، راه‌حل، بازار، تیم و اطلاعات تماس باشد.',
          question_en: 'What are the most critical pieces of information that should be included in a one-page summary for investors?',
          question_fa: 'مهم‌ترین بخش‌های اطلاعاتی که باید در خلاصه یک صفحه‌ای برای سرمایه‌گذاران گنجانده شود کدامند؟',
          userInputRequired: false,
          outputType: 'text',
          ...
          promptConfig: {
            ...
            contextKeys: [
              'idea_title', 'elevator_pitch', 'problem_description', 'product_description', 'som_analysis', 
              'pricing_strategy', 'founding_team', 'fundraising_ask', 'userInput'
            ],
            goal: 'Generate a well-structured and highly condensed one-page business summary.',
            outputFormat: 'A well-formatted text document with clear headings for each key section of the one-pager, designed to be scannable.',
      ...
      stages: [
        {
          ...
          guidance_en: 'Venture capital investors need an "exit event" to realize a return. This typically happens through the sale of your company to a larger corporation (Acquisition) or an IPO. Thinking about this shows you have a long-term vision.',
          guidance_fa: 'سرمایه‌گذاران خطرپذیر برای کسب سود، نیاز به یک "رویداد خروج" دارند. این رویداد معمولاً از طریق فروش شرکت شما به یک شرکت بزرگتر (Acquisition) یا عرضه اولیه سهام در بورس (IPO) اتفاق می‌افتد.',
          question_en: 'In the distant future, what is the most likely exit scenario for your business? What kinds of companies might be interested in acquiring your startup?',
          question_fa: 'در آینده‌ای دور، محتمل‌ترین سناریوی خروج برای کسب‌وکار شما چیست؟ چه شرکت‌هایی ممکن است علاقه‌مند به خرید استارت‌آپ شما باشند؟',
          userInputRequired: false,
          outputType: 'analysis',
          dataKey: 'exit_strategy', // ✅ Correct
          promptConfig: {
            role: 'You are a market analyst AI that identifies potential strategic acquirers for startups.',
            contextKeys: ['competitor_identification', 'som_analysis', 'executive_summary', 'userInput'],
            goal: 'Identify the most likely exit path and list potential strategic acquirers with rationale.',
            outputFormat: 'A brief analysis outlining the most likely exit path (e.g., Acquisition) and a list of 3-5 potential acquiring companies with a short rationale for each.',
