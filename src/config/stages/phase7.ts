...
export const PHASE_7: PhaseConfig = {
  ...
  description_en:
    'In this phase, we address the infrastructure and skeleton of your business. This includes defining the team, the legal structure, day-to-day processes, and most importantly, financial planning. A strong operational and financial roadmap is essential for the long-term sustainability and growth of your startup.',
  description_fa:
    'در این فاز، ما به زیرساخت‌ها و اسکلت کسب‌وکار شما می‌پردازیم. این بخش شامل تعریف تیم، ساختار قانونی، فرآیندهای روزمره و مهم‌تر از همه، برنامه‌ریزی مالی است. داشتن یک نقشه راه مالی و عملیاتی قوی، برای پایداری و رشد بلندمدت استارت‌آپ شما ضروری است.',
      ...
      stages: [
        {
          ...
          guidance_en:
            'Investors often invest in the team, not just the idea. In this section, you should introduce each founding team member, their role, and the relevant experience they bring to the project.',
          guidance_fa:
            'سرمایه‌گذاران اغلب بر روی تیم سرمایه‌گذاری می‌کنند، نه فقط ایده. در این بخش باید هر یک از اعضای تیم موسس، نقش آن‌ها و تجربه مرتبطی که به موفقیت این پروژه کمک می‌کند را معرفی کنید.',
          question_en:
            "Who are the key members of your team? What is each person's primary role and expertise in this startup?",
          question_fa:
            'اعضای کلیدی تیم شما چه کسانی هستند؟ نقش و تخصص اصلی هر فرد در این استارت‌آپ چیست؟',
          ...
          promptConfig: {
            ...
            outputFormat:
              "A brief, powerful bio for each founder, highlighting their role, key responsibilities, and experience that directly supports the startup's mission and unfair advantage.",
        ...
        },
        {
          ...
          guidance_en:
            "You can't do everything alone. Identifying the key roles you will need to fill in the near future (e.g., the next 6-12 months) to grow your business shows foresight.",
          guidance_fa:
            'شما نمی‌توانید همه کارها را به تنهایی انجام دهید. شناسایی نقش‌های کلیدی که در آینده نزدیک (مثلاً ۶ تا ۱۲ ماه آینده) برای رشد کسب‌وکارتان نیاز دارید، نشان‌دهنده آینده‌نگری شماست.',
          question_en:
            'What is the first and most important role you will hire for after securing funding or reaching initial revenue, and why?',
          question_fa:
            'اولین و مهم‌ترین نقشی که پس از جذب سرمایه یا رسیدن به درآمد اولیه استخدام خواهید کرد چیست و چرا؟',
          ...
          promptConfig: {
            ...
            outputFormat:
              'A prioritized list of 1-3 key roles to hire, with a clear justification for why each role is critical for the next stage of growth.',
      ...
      stages: [
        {
          ...
          guidance_en:
            'Choosing the right legal structure (such as an LLC or C-Corp) affects taxes, personal liability, and your ability to raise capital. Consulting with a lawyer is essential.',
          guidance_fa:
            'انتخاب ساختار حقوقی مناسب (مانند سهامی خاص یا مسئولیت محدود) بر مواردی مانند مالیات، مسئولیت شخصی و توانایی جذب سرمایه تاثیر می‌گذارد. مشورت با یک وکیل در این مرحله ضروری است.',
          question_en:
            'What type of legal structure have you considered or registered for your company? What is the reason for this choice?',
          question_fa:
            'چه نوع ساختار حقوقی برای شرکت خود در نظر گرفته‌اید یا ثبت کرده‌اید؟ دلیل این انتخاب چیست؟',
          userInputRequired: false,
          outputType: 'analysis',
          ...
          promptConfig: {
            ...
            outputFormat:
              'A recommendation for a legal structure (LLC or C-Corp) with a clear disclaimer, followed by a brief explanation of the benefits for a startup aiming for growth and investment.',
        ...
        },
        {
          ...
          guidance_en:
            'Your intellectual property (like software code, brand name, logo) is one of your most valuable assets. You should have a plan to protect it.',
          guidance_fa:
            'مالکیت معنوی شما (مانند کد نرم‌افزار، نام برند، لوگو) یکی از باارزش‌ترین دارایی‌های شماست. باید برنامه‌ای برای حفاظت از آن از طریق کپی‌رایت، علائم تجاری یا پتنت داشته باشید.',
          question_en:
            'What is the most important intellectual property of your business? What steps do you plan to take to protect it?',
          question_fa:
            'مهم‌ترین دارایی معنوی کسب‌وکار شما چیست؟ چه اقداماتی برای محافظت از آن انجام داده‌اید یا قصد دارید انجام دهید؟',
          userInputRequired: false,
          outputType: 'analysis',
          ...
          promptConfig: {
            ...
            outputFormat:
              'A list identifying the main IP assets and suggesting the appropriate standard protection mechanism for each.',
            constraints: { tone: 'informative', complexity: 'simple' },
      ...
      stages: [
        {
          ...
          guidance_en:
            "Milestones are significant, measurable goals on your project's timeline. They show you and investors that you are making progress.",
          guidance_fa:
            'نقاط عطف، اهداف مهم و قابل اندازه‌گیری در مسیر پروژه شما هستند. این موارد به شما و سرمایه‌گذاران نشان می‌دهد که در حال پیشرفت هستید.',
          question_en:
            'What are the 3 to 5 main milestones you plan to achieve in the next 12 months?',
          ...
          promptConfig: {
            ...
            outputFormat:
              'A bulleted list of 4-6 key milestones with an estimated timeline (e.g., by Quarter).',
      ...
      stages: [
        {
          ...
          guidance_en:
            'This includes all the one-time expenses you need to start your business, such as legal fees, initial equipment, and initial product development.',
          guidance_fa:
            'این بخش شامل تمام هزینه‌های یک‌باره‌ای است که برای شروع کسب‌وکارتان نیاز دارید. این هزینه‌ها می‌توانند شامل ثبت شرکت، هزینه‌های حقوقی، و توسعه اولیه محصول باشند.',
          question_en:
            'What are the total costs required to get your product to the MVP launch stage? What are the main categories of these expenses?',
          question_fa:
            'مجموع هزینه‌هایی که برای رساندن محصول به مرحله عرضه MVP نیاز دارید چقدر است؟ مهم‌ترین دسته‌بندی‌های این هزینه‌ها چیست؟',
          userInputRequired: false,
          outputType: 'analysis',
          ...
          promptConfig: {
            ...
            outputFormat:
              'A categorized list of estimated one-time costs (e.g., Legal, Tech, Marketing) with a total estimated amount.',
        ...
        },
        {
          ...
          guidance_en:
            'This number shows how much money your company spends (burns) each month to stay operational. These are recurring costs like salaries, rent, server costs, and marketing.',
          guidance_fa:
            'این عدد نشان می‌دهد که شرکت شما برای زنده ماندن، ماهانه چقدر پول می‌سوزاند. این هزینه‌ها شامل موارد تکرارشونده مانند حقوق، اجاره، هزینه سرور و بازاریابی است.',
          question_en:
            'After launching the product, what do you forecast your fixed monthly operating expenses will be?',
          question_fa:
            'پس از عرضه محصول، پیش‌بینی می‌کنید هزینه‌های ثابت ماهانه شما چقدر خواهد بود؟',
          userInputRequired: false,
          outputType: 'analysis',
          ...
          promptConfig: {
            ...
            outputFormat:
              'A categorized list of estimated monthly recurring costs with a total estimated monthly burn rate.',
            constraints: { tone: 'financial', complexity: 'moderate' },
        ...
        },
        {
          ...
          guidance_en:
            'Based on your pricing strategy and marketing goals, create a realistic revenue forecast for the next 12 to 36 months. This should be based on specific assumptions.',
          guidance_fa:
            'بر اساس استراتژی قیمت‌گذاری و اهداف بازاریابی خود، یک پیش‌بینی واقع‌بینانه از درآمد خود برای ۱۲ تا ۳۶ ماه آینده ایجاد کنید. این پیش‌بینی باید بر اساس مفروضات مشخصی باشد.',
          question_en:
            'Based on your revenue model and customer acquisition forecast, what revenue do you expect to achieve in the first year? What are your key assumptions?',
          question_fa:
            'بر اساس مدل درآمدی و پیش‌بینی جذب مشتری، انتظار دارید در سال اول به چه درآمدی برسید؟ مفروضات اصلی شما برای این عدد چیست؟',
          userInputRequired: false,
          outputType: 'analysis',
          ...
          promptConfig: {
            ...
            outputFormat:
              'A brief paragraph explaining the key assumptions, followed by a simple table showing projected monthly users and revenue for the first 12 months.',
