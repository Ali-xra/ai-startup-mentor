...
export const useStartupJourney = (projectId: string | null, locale: Locale) => {
  ...
  const exportProject = (format?: 'json' | 'pdf' | 'word' | 'csv' | 'excel') => {
    exportManager.exportProject(stageManager.stage, startupData, chatManager.messages, format);
  };

  // ============================================
  // Combined Loading State
  // ============================================
  const isLoading = projectManager.isLoading || stageManager.isLoading || chatManager.isLoading;
