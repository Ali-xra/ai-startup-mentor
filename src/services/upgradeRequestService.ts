...
export const upgradeRequestService = {
  ...
  async createUpgradeRequest(
    userId: string,
    requestedPlan: 'pro' | 'enterprise' = 'pro'
  ...
  async approveUpgradeRequest(
    ...
    // Log admin action
    await featureFlagsService.logAdminAction(adminId, 'approve_upgrade_request', request.user_id, {
  ...
  async rejectUpgradeRequest(
    ...
    // Log admin action
    await featureFlagsService.logAdminAction(adminId, 'reject_upgrade_request', request?.user_id, {
      request_id: requestId,
      reason: adminNotes,
    });
  },
  ...
  async extendUpgradeRequest(
    ...
    // Log admin action
    await featureFlagsService.logAdminAction(adminId, 'extend_upgrade_request', request.user_id, {
      request_id: requestId,
