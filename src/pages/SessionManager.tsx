    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 p-6 font-sans transition-colors duration-300">
      <div className="max-w-3xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 mt-1">Session Manager</p>
              </div>
            </div>
            <button
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 mb-6">
            ...
            <div className="space-y-4">
              ...
              <div className="pb-4">
                ...
                <div className="text-slate-900 dark:text-white">{sessionInfo.expires_at}</div>
              </div>
            </div>
            ...
            <div className="mt-6 p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
              <div className="flex gap-3">
                ...
                <div className="text-sm text-yellow-800 dark:text-yellow-200">
                  <strong>توجه:</strong> پاک کردن همه session ها شما را در تمام دستگاه‌ها خارج
                  می‌کند.
                </div>
              </div>
            </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-6">
          <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-4">عملیات سریع</h3>
