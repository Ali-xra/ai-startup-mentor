      ...
      stages: [
        {
          ...
          promptConfig: {
            ...
            outputFormat: 'A structured response containing the best option first, followed by alternatives and a brief explanation.',
        ...
        },
        {
          ...
          guidance_en: 'An elevator pitch is a compelling, 30-second explanation of your startup. You should be able to clearly describe the problem, your solution, the target audience, and your key differentiator to a stranger.',
          ...
          promptConfig: {
            ...
            constraints: { length: '50-75 words', tone: 'persuasive_and_concise', complexity: 'simple' },
        ...
        },
        {
          ...
          guidance_en: 'This is a more detailed paragraph than the elevator pitch, providing a clearer picture of your business. It must be compelling enough to make the reader want to learn more.',
      ...
      stages: [
        {
          ...
          guidance_en: 'Every successful startup is built on solving a real and significant problem. Instead of focusing on your solution first, you must clearly and precisely define the problem itself.',
          ...
          promptConfig: {
            ...
            outputFormat: 'A clear, concise problem statement (75-100 words) focused on the customer\'s pain point.',
        ...
        },
        {
          ...
          guidance_en: 'The significance of the problem determines the market\'s need for your solution. You need to show that this problem is either widespread or extremely costly for a smaller group.',
          guidance_fa: 'اهمیت مشکل، میزان نیاز بازار به راه‌حل شما را تعیین می‌کند. باید نشان دهید که این مشکل برای عده زیادی از افراد وجود دارد و یا برای عده‌ای کم، بسیار دردناک و پرهزینه است.',
          question_en: 'How many people are affected by this problem? How severe is its impact (in terms of cost, time, or frustration)?',
          ...
          promptConfig: {
            ...
            outputFormat: 'Structured analysis with market size implications and impact assessment.',
      ...
      stages: [
        {
          ...
          guidance_en: 'You cannot sell your product to "everyone." Segment your target market into smaller groups with shared characteristics so you can tailor your message more effectively.',
          guidance_fa: 'شما نمی‌توانید محصول خود را به "همه" بفروشید. بازار هدف خود را به گروه‌های کوچکتر با ویژگی‌های مشترک تقسیم کنید تا بتوانید پیام خود را دقیق‌تر به آن‌ها برسانید.',
          ...
          promptConfig: {
            ...
            outputFormat: 'A bulleted list of potential customer segments, with a concluding recommendation for the best initial target.',
        ...
        },
        {
          ...
          guidance_en: 'Focus on one specific group as your very first customers. Create a fictional character for this group with a name, age, job, goals, and specific challenges. This persona will guide your decisions.',
          guidance_fa: 'روی یک گروه خاص به عنوان اولین مشتریان خود تمرکز کنید. برای این گروه یک شخصیت خیالی با اسم، سن، شغل، اهداف و دغدغه‌های مشخص بسازید. این پرسونا در تمام تصمیم‌گیری‌های آینده راهنمای شما خواهد بود.',
          ...
          promptConfig: {
            ...
            outputFormat: 'A detailed persona profile with sections for Demographics, Goals, Frustrations, and Motivations.',
      ...
      stages: [
        {
          ...
          guidance_en: 'In simple terms, explain what your product or service is and what it does. Avoid using overly technical jargon.',
          guidance_fa: 'به زبان ساده توضیح دهید که محصول یا خدمت شما چیست و دقیقاً چه کاری انجام می‌دهد. از به کار بردن اصطلاحات فنی و پیچیده خودداری کنید.',
          ...
          promptConfig: {
            ...
            outputFormat: 'Clear, jargon-free description (100-150 words) that connects features to customer benefits.',
            constraints: { length: '100-150 words', tone: 'benefit-oriented', complexity: 'simple' },
        ...
        },
        {
          ...
          guidance_en: 'Go a little deeper and explain the process of using your product. What are the main features and capabilities of your solution?',
          ...
          promptConfig: {
            ...
            outputFormat: 'A bulleted list of features, with each item explaining the feature and the benefit it provides.',
      ...
      stages: [
        {
          ...
          guidance_en: 'A UVP clearly states why a customer should choose you over your competitors. It should be the primary promise your brand makes to the customer.',
          guidance_fa: 'ارزش پیشنهادی به طور شفاف بیان می‌کند که چرا مشتری باید شما را به جای رقبا انتخاب کند. این جمله باید قول اصلی برند شما به مشتری باشد.',
          ...
          promptConfig: {
            ...
            outputFormat: 'A single, powerful sentence that communicates unique value, often following a standard template.',
        ...
        },
        {
          ...
          guidance_en: 'This is your "secret weapon"—something that cannot be easily copied or bought by your competitors. It could be an expert team, proprietary technology, or exclusive data access.',
          guidance_fa: 'این "سلاح مخفی" شماست؛ چیزی که رقبا نمی‌توانند به سادگی آن را کپی کرده یا بخرند. این مزیت می‌تواند یک تیم متخصص، یک تکنولوژی انحصاری یا دسترسی به داده‌های خاص باشد.',
      ...
      stages: [
        {
          ...
          promptConfig: {
            ...
            outputFormat: 'A structured summary with headings for "Method," "Key Learnings," and "Pivots/Changes Made."',
            constraints: { tone: 'analytical', complexity: 'moderate' },
      ...
      stages: [
        {
          ...
          question_en: 'What is the most important goal you want to achieve in the next 3 months, 1 year, and 3 years?',
          ...
          promptConfig: {
            ...
            outputFormat: 'Three distinct goals, one for each timeframe, following the SMART methodology.',
            constraints: { tone: 'strategic', complexity: 'simple' },
